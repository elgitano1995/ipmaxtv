    ...
    return (
        <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg" ref={containerRef}>
            ...
            {isOpen && (query.trim().length > 0) && (
                <div className="absolute top-full left-0 right-0 mt-2 bg-background border border-border shadow-2xl rounded-2xl overflow-hidden z-[100] animate-in slide-in-from-top-2 fade-in duration-200">
